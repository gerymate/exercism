...
bool permission_check(Action action, AccountStatus user) {
    switch (user) {
        ...
        case AccountStatus::guest: return action == Action::read;
        default: return action != Action::remove;
    }
}
...
bool valid_player_combination(AccountStatus p1, AccountStatus p2) {
    ...
    else if (p1 == AccountStatus::troll || p2 == AccountStatus::troll) return false;
    return true;
}
