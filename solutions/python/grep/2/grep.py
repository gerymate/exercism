""" Module providing a minimal grep implementation """
...
@dataclass
class Options:
    """ Options set for a single grep run """
...
def grep_file(regexp, options: Options, filename):
    """ Search for 'regexp' in 'filename' according to 'options' """
    output = ''
...
def grep(pattern, flags, files):
    """ Search for 'pattern' in 'files' according to 'flags' """
    output = ''
